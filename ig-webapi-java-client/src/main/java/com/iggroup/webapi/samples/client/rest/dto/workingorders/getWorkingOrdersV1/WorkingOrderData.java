...
public class WorkingOrderData {
    ...
    */
    ...
    public BigDecimal getTrailingTriggerIncrement() {
        return trailingTriggerIncrement;
    }

    public void setTrailingTriggerIncrement(BigDecimal trailingTriggerIncrement) {
        this.trailingTriggerIncrement = trailingTriggerIncrement;
    }

    public BigDecimal getTrailingTriggerDistance() {
        return trailingTriggerDistance;
    }

    public void setTrailingTriggerDistance(BigDecimal trailingTriggerDistance) {
        this.trailingTriggerDistance = trailingTriggerDistance;
    }
    ...
    public void setTrailingStopDistance(BigDecimal trailingStopDistance) {
    ...
    public void setTrailingStopIncrement(BigDecimal trailingStopIncrement) {
    ...
    public BigDecimal getContingentStop() {
        return contingentStop;
    }

    public void setContingentStop(BigDecimal contingentStop) {
        this.contingentStop = contingentStop;
    }
    ...
    public BigDecimal getContingentLimit() {
        return contingentLimit;
    }

    public void setContingentLimit(BigDecimal contingentLimit) {
        this.contingentLimit = contingentLimit;
    }
