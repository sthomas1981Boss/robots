...
public class Instrument {
    ...
    */
    ...
    public void setUnit(InstrumentUnitType unit) {
        this.unit = unit;
    }
    ...
    public java.util.List<CurrenciesItem> getCurrencies() {
        return currencies;
    }

    public void setCurrencies(java.util.List<CurrenciesItem> currencies) {
    ...
    public void setSprintMarketsMinimumExpiryTime(Integer sprintMarketsMinimumExpiryTime) {
    ...
    public void setSprintMarketsMaximumExpiryTime(Integer sprintMarketsMaximumExpiryTime) {
        this.sprintMarketsMaximumExpiryTime = sprintMarketsMaximumExpiryTime;
    }

    public java.util.List<MarginDepositBandsItem> getMarginDepositBands() {
        return marginDepositBands;
    }

    public void setMarginDepositBands(java.util.List<MarginDepositBandsItem> marginDepositBands) {
    ...
    public java.util.List<String> getSpecialInfo() {
        return specialInfo;
    }

    public void setSpecialInfo(java.util.List<String> specialInfo) {
