...
public class CreateSessionV2Response {
    ...
    */
    ...
    public java.util.List<AccountsItem> getAccounts() {
        return accounts;
    }

    public void setAccounts(java.util.List<AccountsItem> accounts) {
    ...
    public void setIgCompany(String igCompany) {
        this.igCompany = igCompany;
    }
    ...
    public java.util.List<FormDetailsItem> getFormDetails() {
        return formDetails;
    }

    public void setFormDetails(java.util.List<FormDetailsItem> formDetails) {
