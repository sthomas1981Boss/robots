...
public class GetDealConfirmationV1Response {
    ...
    */
    ...
    public java.util.List<AffectedDealsItem> getAffectedDeals() {
        return affectedDeals;
    }

    public void setAffectedDeals(java.util.List<AffectedDealsItem> affectedDeals) {
    ...
    public void setLimitDistance(Float limitDistance) {
